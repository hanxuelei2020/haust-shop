package com.haust.shop.coupon.service;
...
import com.haust.shop.coupon.mapper.DtsCouponMapper;
...
public class DtsCouponServiceImpl implements DtsCouponService {
	...
	private DtsCoupon.Column[] result = new DtsCoupon.Column[] { DtsCoupon.Column.id, DtsCoupon.Column.name,
			DtsCoupon.Column.desc, DtsCoupon.Column.tag, DtsCoupon.Column.days,
			DtsCoupon.Column.startTime, DtsCoupon.Column.endTime, DtsCoupon.Column.discount, DtsCoupon.Column.min };
