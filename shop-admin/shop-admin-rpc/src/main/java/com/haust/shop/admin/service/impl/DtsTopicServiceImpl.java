...
public class DtsTopicServiceImpl implements DtsTopicService {
	...
	private DtsTopic.Column[] columns = new DtsTopic.Column[] { DtsTopic.Column.id,
			DtsTopic.Column.title, DtsTopic.Column.subtitle, DtsTopic.Column.price,
			DtsTopic.Column.picUrl,
